...
CREATE INDEX idx_ebooks_embedding ON public.ebooks USING hnsw (embedding TEXT_cosine_ops);
...
CREATE INDEX idx_notes_embedding ON public.notes USING hnsw (embedding TEXT_cosine_ops);
